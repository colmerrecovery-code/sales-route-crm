  ...
  return (
    <div className="login">
      <form className="card" onSubmit={submit}>
        <div className="eyebrow">Sales Route CRM</div>
        ...
        <div className="list">
          ...
          <Field label="Password"><input type="password" required minLength={mode === 'register' ? 8 : 1} value={form.password} onChange={set('password')} /></Field>
